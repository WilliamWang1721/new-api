...
export const STATIC_I18N_KEYS = [
  ...
  // Authz catalog (dynamic t(label_key) / t(description_key))
  'Users',
  'Read user',
  'Write user',
  'View users without secrets.',
  'Create, update, or disable non-root users.',
  'Tokens',
  'Read token',
  'Write token',
  'View user API tokens without secrets.',
  'Create or update user API tokens.',
  'Logs',
  'Read logs',
  'Search consume and error logs.',
  'Redemption codes',
  'Read redemption',
  'Write redemption',
  'View redemption codes.',
  'Create or update redemption codes.',
  'Groups',
  'Read group',
  'Write group',
  'View routing groups.',
  'Edit group ratios and usable groups.',
  'Vendors',
  'Read vendor',
  'Write vendor',
  'View vendors.',
  ...
  'Create or change scheduled system tasks.',
  'System options',
  'Read option',
  'Write option',
  'View system options.',
  ...
  'Read hosting',
  'Write hosting',
  'View hosting agents, hooks, incidents, and snapshots.',
  'Create or change hosting agents, hooks, and tokens.',
] as const
